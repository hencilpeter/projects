...
conn = sqlite3.connect('../scheduler/marania_data.db')
...
cursor = conn.execute("select * from mnemonic_data;")

for row in cursor:
    print("id = {}".format(row[0]))
    print("address_id = {}".format(row[1]))
    print("door_number = {}".format(row[2]))
    print("Door Number = {}".format(row[3]))
