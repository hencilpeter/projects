...
conn.execute("INSERT INTO duty_catalog ( duty_code,duty_name,duty_description,salary_type,default_salary,default_department, default_resource_count) \
      VALUES ('DT102', 'machine_operation', 'Machine Operation','Weekly',300,'Production',2);");
conn.execute("INSERT INTO duty_catalog ( duty_code,duty_name,duty_description,salary_type,default_salary,default_department, default_resource_count) \
      VALUES ('DT103', 'bobbin_winding', 'Bobbin Winding','Weekly',300,'Production',2);");
conn.execute("INSERT INTO duty_catalog ( duty_code,duty_name,duty_description,salary_type,default_salary,default_department, default_resource_count) \
      VALUES ('DT104', 'mending', 'Mending','Weekly',300,'Production',2);");
conn.execute("INSERT INTO duty_catalog ( duty_code,duty_name,duty_description,salary_type,default_salary,default_department, default_resource_count) \
