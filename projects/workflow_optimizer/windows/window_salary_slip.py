...
class SalaryAdvice(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.datepicker_ctrl_salary_month = wx.adv.DatePickerCtrl(self, wx.ID_ANY,
    ...
    def refresh_grid_handler(self, event):  # wxGlade: SalaryAdvice.<event_handler>
        ...
        for employee_number in self.employee_salary_dict.keys():
            ...
            self.grid_salary_slip.SetCellValue(current_row, 4,
                                               self.employee_salary_dict[employee_number]["salary_month"])
            self.grid_salary_slip.SetCellValue(current_row, 5, str(
                self.employee_salary_dict[employee_number]["is_salary_data_available"]))
            current_row += 1
    ...
    def add_update_employee_salary_dict(self, _employee_dict):
        ...
        salary_month = self.get_selected_month()
        is_salary_data_available = self.is_salary_data_available(_employee_number=_employee_dict["employee_number"],
                                                                 _salary_month=salary_month)
        self.employee_salary_dict[_employee_dict["employee_number"]] = {"department": _employee_dict["department"],
                                                                        ...
                                                                        "employment_start_date": _employee_dict[
