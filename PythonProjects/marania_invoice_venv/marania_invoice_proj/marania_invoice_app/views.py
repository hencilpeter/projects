...
def payment_allocation_entry(request):
    ...
    for party in parties:
        ...
        for si in SettlementInvoice.objects.filter(customer__code=code):
            ...
            if balance > 0:
                desc = 'Settlement Invoice Issued'
            ...
            if entries_raw:
                ...
                for entry in entries:
                    ...
                    Production.objects.create(
                        ...
                        extra_mesh=float(entry.get("extra_mesh") or 0) or None,
...
def load_production_view(request, pk):
    ...
    try:
        ...
        data = {
            ...
            "extra_mesh": str(production.extra_mesh) if production.extra_mesh else "",
            "mm": production.mm,
            "md": production.md,
...
def profit_analytics_view(request):
    from .models import ProfitAnalytics, Production, MachineOperationalCost, ProcessingCost, AdditionalCost, Product, Parties
    ...
    for pr in profits:
        profits_data.append({
            ...
            "specification": pr.specification or "",
