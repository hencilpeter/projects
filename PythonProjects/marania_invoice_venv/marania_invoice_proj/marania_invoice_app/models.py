...
class PriceListConfiguration(models.Model):
    ...
    gst_included = models.BooleanField(default=False)
    colour_price_per_kg = models.DecimalField(max_digits=10, decimal_places=2, default=10)
    additional_cost_starting_depth_md = models.PositiveIntegerField(default=50)
    small_mesh_depth_price_per_kg = models.DecimalField(max_digits=10, decimal_places=2, default=10)
    processing_cost_per_kg = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    additional_cost_per_kg = models.DecimalField(max_digits=10, decimal_places=2, default=0)
...
class AdditionalCost(models.Model):
    ...
    waste_percentage = models.DecimalField(max_digits=10, decimal_places=2, default=2)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Production(models.Model):
    ...
    knots_capacity_per_day = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    total_meshes = models.IntegerField(blank=True, null=True)
